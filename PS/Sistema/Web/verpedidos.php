...
<body class="">
    <div class="container text-center">
        <div class="mt-5 mb-3">
            <img src="../Recursos\logops.png" alt="" width="300px">
        </div>
        <div>
            <h2 class="dark">Tela de Login</h2>
            ...
            <form action="login.php" method="post">
                <label class="form-label dark" for="usuario">Usuário</label>
                <input class="form-control mb-3" type="email" name="user" id="usuario" required>
                
                <label class="form-label dark" for="pass">Senha</label>
                ...
                <a class="btn btn-warning btn-lg" href="cadastrar.php">Não tenho pedidos</a>
